defmodule Aurora.Uix.Integration.Ash.CrudSpec do
  ...
  Encapsulates the Ash resource, action, and Aurora UIX action name required
  ...
  defstruct [:resource, :action, :auix_action_name]
  ...
  ## Examples
      ...
      iex> new()
      %CrudSpec{resource: nil, action: nil, auix_action_name: nil}
  """
  @spec new() :: t()
  ...
  """
  @spec new(module() | nil, struct() | nil, atom() | nil) :: t()
  def new(resource, action, auix_action_name) do
    %__MODULE__{
      resource: resource,
      action: action,
