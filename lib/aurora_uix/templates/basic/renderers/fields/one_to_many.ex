defmodule Aurora.Uix.Templates.Basic.Renderers.OneToMany do
  ...
  def render(
    ...
    ~H"""
    <div class="one-to-many-field" name={"auix-one_to_many-#{@auix.association.parsed_opts.module}"}>
      <div class="one-to-many-header">
        <.label for={"auix-one_to_many-#{@auix.association.parsed_opts.module}__#{@field.key}-#{@auix.layout_type}"}>{ "#{@auix.association.related_parsed_opts.title} Elements"}
            <div name="auix-one_to_many-header-actions" class="one-to-many-header-actions">
      ...
      <div class="one-to-many-footer">
        <div class="one-to-many-footer-actions" name="auix-one_to_many-footer_actions">
