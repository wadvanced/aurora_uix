    ...
    <div class="container">
      ...
      <.auix_simple_form :let={index_layout_form} for={@auix.index_layout_form} name="auix-index_layout_form" phx-change="index-layout-change">
        ...
        >
          ...
          <:filter_element>
            <div :if={@auix.index_filters_actions != []} class="filter-element-actions">
              <div class="filter-element-actions-content">
                <span class="filter-element-actions-focus-ring" />
                <span
                  :for={%{function_component: action} <- @auix.index_filters_actions}
                      class="filter-element-action-button">
                  {action.(%{auix: @auix})}
                </span>
              </div>
            </div>
