      ...
      docs: [
        ...
        groups_for_modules: [
          ...
          "Basic Template": [
            ...
            Aurora.Uix.Templates.Basic.Actions.Show,
            ...
            Aurora.Uix.Templates.Basic.Generators.ShowGenerator,
            ...
            Aurora.Uix.Templates.Basic.Handlers.Show,
            Aurora.Uix.Templates.Basic.Handlers.ShowImpl,
