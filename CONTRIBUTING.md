...
- `guides/customization/` — Customization & extension (styling, theming, components, actions)
- `guides/advanced/` — Advanced usage

> The `doc/` directory is ExDoc build output generated by `mix docs` — never hand-edit it.
