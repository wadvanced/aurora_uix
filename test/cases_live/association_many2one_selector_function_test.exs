defmodule Aurora.UixWeb.Test.AssociationMany2OneSelectorFunctionTest do
  ...
  auix_resource_metadata(:product, context: Inventory, schema: Product) do
    field(:product_location_id,
      option_label: &__MODULE__.option_label/1
    )
  end
  ...
  test "check_show", %{conn: conn} do
    ...
    {:ok, view, html} =
      live(
        conn,
        "/association-many_to_one_selector-function-products/#{product_id}/show"
      )
