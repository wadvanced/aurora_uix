defmodule Aurora.UixWeb.Test.ManualResourceTest do
  ...
  @auix_resource_metadata %{
    product_location: %Aurora.Uix.Resource{
      ...
      schema: Aurora.Uix.Guides.Inventory.ProductLocation,
      context: Aurora.Uix.Guides.Inventory,
      fields: %{
    ...
    product_transaction: %Aurora.Uix.Resource{
      ...
      schema: Aurora.Uix.Guides.Inventory.ProductTransaction,
      context: Aurora.Uix.Guides.Inventory,
      fields: %{
        type: %Aurora.Uix.Field{
          key: :type,
        ...
        product: %Aurora.Uix.Field{
          ...
          data: %{
            ...
            related: Aurora.Uix.Guides.Inventory.Product,
            related_key: :id
          }
        },
    ...
    product: %Aurora.Uix.Resource{
      name: :product,
      schema: Aurora.Uix.Guides.Inventory.Product,
      context: Aurora.Uix.Guides.Inventory,
      fields: %{
        name: %Aurora.Uix.Field{
          key: :name,
        ...
        product_transactions: %Aurora.Uix.Field{
          ...
          data: %{
            ...
            related: Aurora.Uix.Guides.Inventory.ProductTransaction,
        ...
        product_location_id: %Aurora.Uix.Field{
          ...
          data: %{
            ...
            related: Aurora.Uix.Guides.Inventory.ProductLocation,
            option_label: :name,
            related_key: :id
          }
        },
  ...
  test "Test ensure all fields are displayed in SHOW", %{conn: conn} do
    ...
    {:ok, view, html} = live(conn, "/manual-resource-products/#{product_id}/show")
