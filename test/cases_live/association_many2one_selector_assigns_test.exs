defmodule Aurora.UixWeb.Test.AssociationMany2OneSelectorAssignsTest do
  ...
  auix_resource_metadata(:product, context: Inventory, schema: Product) do
    field(:product_location_id,
      option_label: &__MODULE__.option_label/2
    )
  end
  ...
  test "check_show", %{conn: conn} do
    ...
    {:ok, view, html} =
      live(
        conn,
        "/association-many_to_one_selector-assigns-products/#{product_id}/show"
      )
